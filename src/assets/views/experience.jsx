...
const FeaturedWorkSection = () => {
  const cardsData = Array(6).fill({
    ...
    vision: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.",
    visualUrl: "https://tse1.mm.bing.net/th/id/OIP.l5Hgjce3EixFXzuDu0T3uwHaLG?rs=1&pid=ImgDetMain&o=7&rm=3", 
    visualAlt: "Lorem Ipsum"
  });

  return (
    <section id="experience" className="relative w-full max-w-7xl mx-auto px-4 py-32 md:px-8">
