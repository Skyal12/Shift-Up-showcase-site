  ...
  return (
    <>
                ...
                {card.type === 'content' && (
                  ...
                  >
                    ...
                    <div className="w-full md:w-1/2 h-full min-h-[350px] flex items-center justify-center relative">
                      {card.images && (
                        <div className={`w-full h-full flex ${card.images.length > 1 ? 'flex-row gap-6 md:gap-8 justify-center items-center' : 'justify-center items-center'}`}>
      ...
      {selectedImage && (
        ...
        >
          <div className="relative max-w-5xl max-h-screen w-full flex flex-col items-center justify-center cursor-default" onClick={(e) => e.stopPropagation()}>
            {/* Bouton Fermer */}
            <button 
