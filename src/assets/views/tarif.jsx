...
export default function Tarif() {
  ...
  return (
    <section
      id="tarif"
      className="tarif snap-center w-full flex bg-[#ff4800] flex-row justify-center items-center p-20 pt-32 pb-32 h-screen"
    >
      <div className="container-offers w-1/2 flex flex-col justify-center items-center">
        <div
          className={`offer1 mb-12 w-4/5 h-32 rounded-xl flex flex-col justify-center items-center bg-[#FFF] text-black transition-transform duration-300 ${
        ...
        <div
          className={`offer2 mb-12 w-3/4 h-32 rounded-xl flex flex-col justify-center items-center bg-[#FFF] text-black transition-transform duration-300 ${
        ...
        <div
          className={`offer3 mb-12 w-3/4 h-32 rounded-xl flex flex-col justify-center items-center bg-[#FFF] text-black transition-transform duration-300 ${
      ...
      <div className="container-info bg-[#FFF] text-black w-1/2 h-4/4 rounded-xl p-4 flex flex-col justify-center">
